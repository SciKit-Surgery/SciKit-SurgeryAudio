...
===============================================
Requirements for scikit-surgeryaudio
===============================================

This is the software requirements file for scikit-surgeryaudio, part of the
SNAPPY project. The requirements listed below should define
what scikit-surgeryaudio does. Each requirement can be matched to a unit test that
